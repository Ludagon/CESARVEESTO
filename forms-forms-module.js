...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<div class=\"main-content\">\n  <div class=\"container-fluid\">\n    <div class=\"row\">\n        <div class=\"col-md-8 ml-auto mr-auto\">\n            <div class=\"card\">\n              <div *ngIf=\"isCerradura===true\" class=\"card-header card-header-icon card-header-danger\">\n                <div class=\"card-icon\">\n                  <i class=\"material-icons\">mail_outline</i>\n                </div>\n                <h4 class=\"card-title\">Contactenos -\n                  <small class=\"category\">verifique los datos antes de enviar el mensaje</small>\n                </h4>\n              </div>\n\n              <div *ngIf=\"isCerradura===false\" class=\"card-header card-header-icon card-header-rose\">\n                <div class=\"card-icon\">\n                  <i class=\"material-icons\">mail_outline</i>\n                </div>\n                <h4 class=\"card-title\">Contactenos -\n                  <small class=\"category\">verifique los datos antes de enviar el mensaje</small>\n                </h4>\n              </div>\n\n\n              <div class=\"card-body\">\n                <form>\n                  <div class=\"row\">\n                    <div class=\"col-md-5\">\n                        <mat-form-field class=\"example-full-width\" style=\"margin-top: 4vh;\">\n                            <input #email matInput placeholder=\"Correo electronico\" type=\"email\" [formControl]=\"emailFormControl\" [errorStateMatcher]=\"matcher\">\n                            <mat-error *ngIf=\"emailFormControl.hasError('email') && !emailFormControl.hasError('required')\">\n                              Coloque una dirección email válida\n                          </mat-error>\n                          <mat-error *ngIf=\"emailFormControl.hasError('required')\">\n                              Email es <strong>requerido</strong>\n                          </mat-error>\n                          </mat-form-field>\n                    </div>\n                  </div>\n                  <div class=\"row\">\n                    <div class=\"col-md-6\">\n                        <mat-form-field class=\"example-full-width\">\n                          <input #name matInput placeholder=\"Nombre\" [formControl]=\"nameFormControl\" [errorStateMatcher]=\"matcher\">\n                          <mat-error *ngIf=\"nameFormControl.hasError('required')\">\n                              El nombre es <strong>requerido</strong>\n                          </mat-error>\n                          </mat-form-field>\n                          \n                    </div>\n                    <div class=\"col-md-6\">\n                        <mat-form-field class=\"example-full-width\">\n                          <input #subject matInput placeholder=\"Asunto\" [formControl]=\"subjectFormControl\" [errorStateMatcher]=\"matcher\">\n                          <mat-error *ngIf=\"subjectFormControl.hasError('required')\">\n                              El asunto es <strong>requerido</strong>\n                          </mat-error>\n                          </mat-form-field>\n                    </div>\n                  </div>\n                  <div class=\"row\">\n                    <div class=\"col-md-12\">\n                        <mat-form-field class=\"example-full-width\">\n                          <textarea #text matInput maxlength=\"500\" [formControl]=\"textFormControl\" [errorStateMatcher]=\"matcher\" cdkTextareaAutosize #autosize=\"cdkTextareaAutosize\" cdkAutosizeMinRows=\"3\" cdkAutosizeMaxRows=\"10\" name=\"mensaje\" ngModel></textarea>\n                          <mat-hint align=\"start\"><strong>Nunca se le solicitara información personal</strong></mat-hint>\n                          <mat-hint align=\"end\">{{textFormControl.value.length}} / 500</mat-hint>\n                          <mat-error *ngIf=\"textFormControl.hasError('required')\">\n                              Introduzca el texto del mensaje\n                          </mat-error>\n                          </mat-form-field>\n                    </div>\n                  </div>\n\n                  <button (click)=\"showSwal()\" style=\"margin-top: 1.5em;\" *ngIf=\"isCerradura===true\" mat-raised-button type=\"submit\" [disabled]=\"(!emailFormControl.valid) || (!subjectFormControl.valid) || (!nameFormControl.valid) || (!textFormControl.valid)\" class=\"btn btn-danger pull-right\">Enviar Correo</button>\n                  <button  (click)=\"showSwal()\" style=\"margin-top: 1.5em;\" *ngIf=\"isCerradura==false\" mat-raised-button type=\"submit\" [disabled]=\"(!emailFormControl.valid) || (!subjectFormControl.valid) || (!nameFormControl.valid) || (!textFormControl.valid)\" class=\"btn btn-rose pull-right\">Enviar Correo</button>\n                  <div class=\"clearfix\"></div>\n                </form>\n              </div>\n            </div>\n          </div>\n    </div>\n  </div>\n</div>\n");

/***/ }),

/***/ "./node_modules/raw-loader/dist/cjs.js!./src/app/forms/validationforms/field-error-display/field-error-display.component.html":
/*!************************************************************************************************************************************!*\
  !*** ./node_modules/raw-loader/dist/cjs.js!./src/app/forms/validationforms/field-error-display/field-error-display.component.html ***!
  \************************************************************************************************************************************/
/*! exports provided: default */
...
/*!**************************************************************!*\
  !*** ./src/app/forms/regularforms/regularforms.component.ts ***!
  \**************************************************************/
/*! exports provided: MyErrorStateMatcher, RegularFormsComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var RegularFormsComponent = /** @class */ (function () {
    function RegularFormsComponent(router, _MessageService) {
        this.router = router;
        this._MessageService = _MessageService;
        this.nameFormControl = new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"]('', [
            _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required,
        ]);
        this.subjectFormControl = new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"]('', [
            _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required,
        ]);
        this.textFormControl = new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"]('', [
            _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required,
        ]);
    ...
    RegularFormsComponent.prototype.contactForm = function () {
        var _this = this;
        var formulario = {
            nombre: this.nameFormControl.value,
            asunto: this.subjectFormControl.value,
            email: this.emailFormControl.value,
            mensaje: this.textFormControl.value,
        };
        this._MessageService.sendMessage(formulario).subscribe(function () {
            _this.nameFormControl.reset();
            _this.subjectFormControl.reset();
            _this.emailFormControl.reset();
            _this.textFormControl.reset("");
        });
    };
    RegularFormsComponent.prototype.clearForm = function () {
        this.emailFormControl.reset();
        this.nameFormControl.reset();
        this.subjectFormControl.reset();
        this.textFormControl.reset("");
    };
    RegularFormsComponent.prototype.showSwal = function () {
        var nombre = this.nameFormControl.value;
        this.contactForm();
        if (this.isCerradura == true) {
            sweetalert2__WEBPACK_IMPORTED_MODULE_3___default()({
                title: "Gracias por tu interes en nuestros productos vittoria",
                text: nombre + ", En breve nos comunicaremos ",
            ...
            sweetalert2__WEBPACK_IMPORTED_MODULE_3___default()({
                title: "Gracias por tu interes en nuestros productos vittoria",
                text: nombre + ",  En breve te atenderemos ",
                buttonsStyling: false,
    ...
    RegularFormsComponent.prototype.getErrorMessage = function (type) {
        console.log(type);
        switch (type) {
            case type = 'm':
    ...
    RegularFormsComponent.ctorParameters = function () { return [
    ...
    ], RegularFormsComponent.prototype, "email", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewChild"])('name', { static: false }),
        __metadata("design:type", _angular_core__WEBPACK_IMPORTED_MODULE_0__["ElementRef"])
    ], RegularFormsComponent.prototype, "name", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewChild"])('subject', { static: false }),
        __metadata("design:type", _angular_core__WEBPACK_IMPORTED_MODULE_0__["ElementRef"])
    ], RegularFormsComponent.prototype, "subject", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewChild"])('text', { static: false }),
        __metadata("design:type", _angular_core__WEBPACK_IMPORTED_MODULE_0__["ElementRef"])
    ], RegularFormsComponent.prototype, "text", void 0);
    RegularFormsComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_1__["Router"], _services_message_service__WEBPACK_IMPORTED_MODULE_4__["MessageService"]])
...
var FieldErrorDisplayComponent = /** @class */ (function () {
    ...
    FieldErrorDisplayComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            template: __importDefault(__webpack_require__(/*! raw-loader!./field-error-display.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/forms/validationforms/field-error-display/field-error-display.component.html")).default,
            styles: [__importDefault(__webpack_require__(/*! ./field-error-display.component.css */ "./src/app/forms/validationforms/field-error-display/field-error-display.component.css")).default]
        })
...
var WizardComponent = /** @class */ (function () {
    ...
    WizardComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            styles: [__importDefault(__webpack_require__(/*! ./wizard.component.css */ "./src/app/forms/wizard/wizard.component.css")).default]
        }),
        __metadata("design:paramtypes", [_angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormBuilder"]])
    ], WizardComponent);
